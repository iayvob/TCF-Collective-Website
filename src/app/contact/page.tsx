...
const FormSchema = z.object({
  ...
  title: z.string(),
  help: z.enum(["Evaluate for my company", "Learn More", "Other"]),
  services: z.enum([
    "Graphic Design",
...
type FormValues = {
  ...
  email: string;
  title: string;
  help: "Evaluate for my company" | "Learn More" | "Other";
  services:
    | "Graphic Design"
    | "Social Media Marketing"
    | "Video Production"
            ...
            >
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate for my company">
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to TCF&apos; sending marketing communications related
                  to TCF
                </div>
              </div>
