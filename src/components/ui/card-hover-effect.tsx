...
import { CheckCheckIcon, VerifiedIcon } from "lucide-react";
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-gray-900 font-bold tracking-wide mt-4 flex gap-2 items-center", className)}>
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-8 text-gray-800 tracking-wide leading-relaxed text-sm",
        className
      )}
    >
      {children}
